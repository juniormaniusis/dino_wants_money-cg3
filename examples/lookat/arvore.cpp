...
void Arvore::initializeGL(GLuint program, std::string assetsPath, glm::vec3 posicao) {
  // m_posicaoFinal = posFinal;
  // m_posicaoInicial = posInicial;
  // m_model.loadDiffuseTexture(assetsPath + "maps/Arvore.png");
...
void Arvore::update(float deltaTime) {}
