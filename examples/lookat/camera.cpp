...
void Camera::updatePosition(glm::vec3 pacmanPosition,
  ...
  // calcula a nova posição da camera com base na rotação do dinossauro e o
...
void Camera::alterarDistancia(float mouseWheel) {
  // altera distancia da camera até o dinossaru, com base no scroll do mouse
...
void Camera::angulo(float mouse) {
  // gira a camera em torno do dinossauro;
  float delta = mouse * 35.0f;
